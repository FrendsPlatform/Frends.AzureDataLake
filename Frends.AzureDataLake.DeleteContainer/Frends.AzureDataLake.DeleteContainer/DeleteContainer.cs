...
using Frends.AzureDataLake.DeleteContainer.Helpers;
...
public static class AzureDataLake
{
    ...
    /// <returns>Object { bool Success, bool ContainerWasDeleted, string Message, Error Error }</returns>
    ...
    )
    {
        ...
        try
        {
            ...
            return new Result { Success = true, ContainerWasDeleted = true, Message = "Container deleted successfully." };
        }
        catch (Exception ex)
        {
